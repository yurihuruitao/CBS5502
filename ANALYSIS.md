...
| 词性 | 样本数 | BiLSTM | BERT-Frozen | BERT | RoBERTa | SBERT |
|------|--------|--------|-------------|------|---------|-------|
| Adj | 993 | 0.463 | 0.663 | **0.676** | 0.667 | 0.562 |
| Adv | 237 | 0.532 | 0.555 | 0.530 | **0.559** | 0.494 |
| Noun | 2,734 | 0.609 | 0.737 | **0.753** | 0.728 | 0.604 |
| Verb | 3,512 | 0.605 | 0.665 | **0.705** | 0.697 | 0.514 |
...
| 义项数 | 样本数 | BiLSTM | BERT-Frozen | BERT | RoBERTa | SBERT |
|--------|--------|--------|-------------|------|---------|-------|
| ≤3 | 2,587 | 0.478 | 0.606 | **0.657** | 0.638 | 0.545 |
| 4-6 | 1,648 | 0.448 | 0.627 | 0.626 | 0.597 | 0.532 |
| ≥7 | 3,241 | 0.539 | 0.661 | **0.674** | 0.666 | 0.497 |
...
| 词频 | 样本数 | BiLSTM | BERT-Frozen | BERT | RoBERTa | SBERT |
|------|--------|--------|-------------|------|---------|-------|
| 低频 | 1,135 | 0.495 | 0.537 | **0.597** | 0.570 | 0.453 |
| 中频 | 416 | 0.392 | 0.549 | **0.612** | 0.598 | 0.579 |
| 高频 | 5,925 | 0.571 | 0.678 | **0.689** | 0.677 | 0.531 |
